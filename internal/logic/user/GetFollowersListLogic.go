...
func (l *GetFollowersListLogic) GetFollowersList(in *UserService.GetFollowersListRequest) (*UserService.GetFollowersListResponse, error) {
	// Step 1: 获取被关注列表
	...
	return &UserService.GetFollowersListResponse{
		UserIds: userIds,
	}, nil
}
