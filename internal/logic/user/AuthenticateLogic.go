...
func (l *AuthenticateLogic) Authenticate(in *UserService.AuthenticateRequest) (*UserService.AuthenticateResponse, error) {
	// Step 1: 验证邮箱是否存在
	...
	return &UserService.AuthenticateResponse{
		UserId: user.Id,
	}, nil
}
